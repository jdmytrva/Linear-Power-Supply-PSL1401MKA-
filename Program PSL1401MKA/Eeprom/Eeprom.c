...
uint8_t CalibrationWriteToFlash(void)
{
	...
	flash_write( CalibrationData.CalibrationValueForVoltage_AddresInEEprom, CalibrationData.CalibrationFor_U_PS1);
	flash_write( CalibrationData.CalibrationValueForVoltage1_AddresInEEprom, CalibrationData.CalibrationFor_U_PS2);
	flash_write( CalibrationData.CalibrationValueForVoltage2_AddresInEEprom, CalibrationData.CalibrationFor_U_PS3);
...
uint8_t CalibrationFactoryWriteToFlash(void)
{
	...
	flash_write( CalibrationDataFactory.CalibrationValueForVoltage_AddresInEEprom, CalibrationDataFactory.CalibrationFor_U_PS1);
	flash_write( CalibrationDataFactory.CalibrationValueForVoltage1_AddresInEEprom, CalibrationDataFactory.CalibrationFor_U_PS2);
	flash_write( CalibrationDataFactory.CalibrationValueForVoltage2_AddresInEEprom, CalibrationDataFactory.CalibrationFor_U_PS3);
...
uint8_t CalibrationReadFromFlash(void)
{
	...
	CalibrationData.CalibrationFor_U_PS1 = flash_read(CalibrationData.CalibrationValueForVoltage_AddresInEEprom,10,100000);
	CalibrationData.CalibrationFor_U_PS2 = flash_read(CalibrationData.CalibrationValueForVoltage1_AddresInEEprom,10,100000);
	CalibrationData.CalibrationFor_U_PS3 = flash_read(CalibrationData.CalibrationValueForVoltage2_AddresInEEprom,10,100000);
...
uint8_t CalibrationReadFromFlashForVerify(void)
{
	...
	CalibrationDataForVerify.CalibrationFor_U_PS1 = flash_read(CalibrationDataForVerify.CalibrationValueForVoltage_AddresInEEprom,10,100000);
	CalibrationDataForVerify.CalibrationFor_U_PS2 = flash_read(CalibrationDataForVerify.CalibrationValueForVoltage1_AddresInEEprom,10,100000);
	CalibrationDataForVerify.CalibrationFor_U_PS3 = flash_read(CalibrationDataForVerify.CalibrationValueForVoltage2_AddresInEEprom,10,100000);
...
{
	Print_to_USART1_d(SaveDataWhenPowerOff.CurrentConsumption5ms,"Write C maH : ",0);
